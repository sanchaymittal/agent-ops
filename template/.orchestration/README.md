...
- `prompts/` — one file per dispatch: `{{ISSUE_PREFIX_LOWER}}-xx-<role>-<slug>.md`. The idempotent unit of dispatch: a failed/hung worker is respawned from the same file, never rewritten mid-flight.
